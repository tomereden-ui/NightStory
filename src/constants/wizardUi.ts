...
const EN: WizardUiCopy = {
  ...
  readyToHearStory: "Let's create the magic! ✨",
  lunaLabel: "Luna",
...
const HE: WizardUiCopy = {
  ...
  readyToHearStory: "בואו ניצור את הקסם! ✨",
  lunaLabel: "לונה",
  areYouReady: "מוכנים?",
...
const ES: WizardUiCopy = {
  ...
  readyToHearStory: "¡Creemos la magia! ✨",
  lunaLabel: "Luna",
  areYouReady: "¿Listos?",
...
const FR: WizardUiCopy = {
  ...
  readyToHearStory: "Créons la magie ! ✨",
  lunaLabel: "Luna",
  areYouReady: "Prêts ?",
...
const DE: WizardUiCopy = {
  ...
  readyToHearStory: "Lass uns die Magie erschaffen! ✨",
  lunaLabel: "Luna",
  areYouReady: "Bereit?",
...
const PT: WizardUiCopy = {
  ...
  readyToHearStory: "Vamos criar a magia! ✨",
  lunaLabel: "Luna",
  areYouReady: "Prontos?",
...
const IT: WizardUiCopy = {
  ...
  readyToHearStory: "Creiamo la magia! ✨",
  lunaLabel: "Luna",
  areYouReady: "Pronti?",
...
const HI: WizardUiCopy = {
  ...
  readyToHearStory: "चलो जादू बनाते हैं! ✨",
  lunaLabel: "लूना",
