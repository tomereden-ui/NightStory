...
// ─── Component ────────────────────────────────────────────────────────────────
// Internal TTS audition tool — Gemini 2.5, Gemini 3.1, ElevenLabs & Google
// Chirp3-HD. Lives inside Admin Services > Voices; the parent page already
// gates the whole /admin route to the admin account, so this panel doesn't
...
export default function VoiceManagerPanel() {
  ...
  return (
    <div style={{ background: "#0a0a0f", color: "#ddd", fontFamily: "monospace", padding: 20, borderRadius: 16 }}>
      <h2 style={{ fontSize: 16, fontWeight: 700, marginBottom: 4 }}>🎙️ Voice Manager</h2>
      <p style={{ color: "#666", fontSize: 12, marginBottom: 18 }}>Internal TTS audition tool — Gemini 2.5, Gemini 3.1, ElevenLabs &amp; Google Chirp3-HD. Not user-facing.</p>
