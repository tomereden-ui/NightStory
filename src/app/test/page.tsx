    ...
    <>
      ...
      <div className="rounded-2xl px-4 py-3.5"
        ...
        <div className="flex items-center gap-3 mb-2">
          <button
            onClick={() => { const a = audioRef.current; if (!a) return; playing ? a.pause() : a.play(); }}
            className="w-10 h-10 rounded-full flex items-center justify-center text-fs-heading flex-shrink-0 active:scale-95"
    ...
    <div className="min-h-full" style={{ background: "transparent" }}>
      <div className="px-5 pt-12 pb-36">
        ...
        <div className="flex items-center justify-center mb-7">
          <h1 className="text-fs-heading font-semibold text-white tracking-wide">Audio Test Lab</h1>
        </div>
        ...
        <div className="mb-2">
          ...
          {mode === "tts" ? (
            <textarea key="tts" value={ttsText} onChange={(e) => setTtsText(e.target.value)}
              ...
              className="w-full rounded-xl px-4 py-3 text-fs-body text-white placeholder-white/20 outline-none resize-none leading-relaxed"
              ...
              return (
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-xl px-3 py-2.5 text-fs-body text-white placeholder-white/20 outline-none"
