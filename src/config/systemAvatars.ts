...
export const SYSTEM_AVATARS: SystemAvatar[] = [
  ...
  { id: "adult-dad-beard",         label: "Dad",     category: "adult", emoji: "🌟", url: mini("Dad-beard-sweater",      "d1f4cc"), prompt: `friendly bearded father with warm smile and steady gaze, soft green background, ${P}` },
  { id: "adult-grandma-kind",      label: "Grandma", category: "adult", emoji: "🌺", url: mini("Grandma-white-hair",     "ffe4e1"), prompt: `kind white-haired grandmother with gentle smile and rosy cheeks, soft pink background, ${P}` },
  { id: "adult-grandpa-wise",      label: "Grandpa", category: "adult", emoji: "🎩", url: mini("Grandpa-silver-wise",    "e1f0ff"), prompt: `wise silver-haired grandfather with distinguished kind eyes, soft blue background, ${P}` },
  { id: "adult-teacher-bright",    label: "Teacher", category: "adult", emoji: "🍎", url: mini("Teacher-glasses-bright", "fff3cd"), prompt: `enthusiastic teacher with glasses and bright encouraging smile, warm yellow background, ${P}` },
  { id: "adult-chef-jolly",        label: "Chef",    category: "adult", emoji: "🍳", url: mini("Chef-toque-jolly",       "ffdfbf"), prompt: `jolly chef with white toque hat and cheerful expression, warm peach background, ${P}` },
